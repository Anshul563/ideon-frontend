...
const navItems = [
  ...
  { name: "Market Research", href: "/dashboard/research", icon: Search },
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col group-data-[collapsible=icon]:hidden">
            <div className="flex items-center gap-2">
              ...
              <span className="px-1.5 py-0.5 rounded-md bg-sidebar-primary/10 text-sidebar-primary text-[10px] font-bold border border-sidebar-primary/20 leading-none">v1.0</span>
            </div>
                  ...
                  <SidebarMenuItem key={item.href}>
                    ...
                    >
                      <Link href={item.href}>
                        ...
                        {isActive && <div className="ml-auto w-1 h-3 rounded-full bg-sidebar-primary" />}
                      </Link>
                    </SidebarMenuButton>
                  </SidebarMenuItem>
                );
      ...
      <SidebarFooter className="p-4">
        <div className="px-3 mb-4 group-data-[collapsible=icon]:hidden">
          {(!user || user.plan === "free" || !user.plan) && (
            <div className="p-3.5 rounded-2xl bg-sidebar-primary/5 border border-sidebar-primary/10 backdrop-blur-sm mb-3 group/card hover:border-sidebar-primary/30 transition-all flex items-center justify-between gap-3">
               ...
               <Link href="/pricing">
                  <Button size="sm" className="h-7 px-3 rounded-lg bg-sidebar-primary hover:bg-sidebar-primary/90 text-sidebar-primary-foreground text-[9px] font-black uppercase tracking-widest shadow-lg shadow-sidebar-primary/10 transition-all active:scale-95">
                     Pro
                  </Button>
               </Link>
            </div>
          )}
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-sidebar-accent/20 border border-sidebar-border">
            <div className="relative flex items-center justify-center">
              <div className="w-1.5 h-1.5 rounded-full bg-sidebar-primary shadow-[0_0_8px_rgba(var(--primary),0.4)]" />
              <div className="absolute inset-0 w-1.5 h-1.5 rounded-full bg-sidebar-primary animate-ping opacity-60" />
            </div>
