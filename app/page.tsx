  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 z-0 pointer-events-none hero-bg">
        ...
        <div className="absolute top-[40%] left-[60%] w-[30%] h-[30%] rounded-full bg-accent/5 blur-[100px] animate-pulse delay-1000" />
      </div>
      ...
      >
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/5 text-primary text-[10px] font-black uppercase tracking-[0.2em] border border-primary/10 mb-8 backdrop-blur-md hero-sub">
          ...
          <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-6 hero-sub">
            <Link
              href="/register"
              className="group relative px-10 py-5 rounded-2xl text-lg font-black uppercase tracking-widest bg-primary text-primary-foreground shadow-2xl shadow-primary/30 transition-all hover:scale-105 active:scale-95"
            >
              Start Free Scan
            ...
            <Link
              href="/pricing"
              className="px-10 py-5 rounded-2xl text-lg font-black uppercase tracking-widest border border-border text-foreground backdrop-blur-sm hover:bg-muted/5 transition-all"
            >
              View Methodology
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-40 reveal">
            <div className="inline-block mb-6">
              <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary text-xs font-black uppercase tracking-[0.2em] border border-primary/20 backdrop-blur-sm">
                <Sparkles className="w-3 h-3 animate-pulse" />
                The Process
              </span>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute left-4 md:left-1/2 top-0 bottom-0 md:-translate-x-1/2 flex justify-center">
              <div className="relative w-1 h-full">
                ...
                <div className="absolute inset-0 w-full bg-linear-to-b from-primary via-accent to-secondary opacity-20 rounded-full blur-xl" />
                {/* Border line */}
                <div className="absolute inset-0 w-full bg-border rounded-full" />
                {/* Animated progress line */}
                <div
                  ref={lineRef}
                  className="absolute top-0 w-full bg-linear-to-b from-primary via-accent to-secondary origin-top shadow-[0_0_30px_rgba(var(--primary),0.5)] rounded-full blur-sm"
                />
              </div>
            </div>
          ...
          {[
            ...
            return (
              <motion.div
                key={i}
                whileHover={{ y: -10 }}
                className="group relative p-1 rounded-[32px] bg-muted/5 border border-border hover:border-primary/20 transition-all duration-500 shadow-2xl"
              >
                <div className="p-10 rounded-[31px] bg-card/80 backdrop-blur-xl h-full flex flex-col justify-between">
                  <div>
                    <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center border border-primary/20 mb-8 group-hover:scale-110 group-hover:bg-primary group-hover:text-primary-foreground transition-all">
      ...
      <section className="relative z-10 py-32 px-6 reveal">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-[64px] overflow-hidden bg-primary p-20 md:p-32 text-center shadow-[0_0_100px_rgba(var(--primary),0.3)]">
            ...
            <div className="relative z-10">
              ...
              <Link
                href="/register"
                className="inline-block px-12 py-6 bg-background text-foreground hover:bg-muted rounded-2xl text-xl font-black uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-2xl"
              >
    ...
    >
      <div className="w-full md:w-1/2 flex justify-center md:px-12">
        ...
        >
          ...
          <div className="absolute inset-0 bg-linear-to-br from-primary/20 to-transparent rounded-[32px] opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-2xl" />

          {/* Card */}
          <div
            className={`relative p-1 rounded-[32px] bg-linear-to-br ${step.gradient} border ${step.borderColor} backdrop-blur-2xl overflow-hidden shadow-xl group-hover:shadow-[0_0_40px_rgba(var(--primary),0.2)] transition-all duration-500`}
          >
            <div className="relative p-8 rounded-[30px] bg-card/60 backdrop-blur-xl h-full flex flex-col">
              {/* Number background */}
              ...
              <motion.div
                ...
                className={`w-16 h-16 rounded-2xl bg-linear-to-br ${step.gradient} flex items-center justify-center border ${step.borderColor} mb-6 group-hover:scale-110 transition-transform shadow-lg relative z-10 shrink-0`}
              >
      ...
      <div className="absolute left-4 md:left-1/2 top-0 md:-translate-x-1/2 flex justify-center z-20">
        ...
        >
          {/* Outer glow */}
          <div
            className={`absolute inset-0 ${step.dotColor} rounded-full opacity-30 blur-lg animate-pulse`}
            style={{
              width: "32px",
              height: "32px",
              marginLeft: "-16px",
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            className={`w-6 h-6 ${step.dotColor} rounded-full relative z-10 border-4 border-background`}
          />
        </motion.div>
      </div>
